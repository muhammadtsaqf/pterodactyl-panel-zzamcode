                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select name="role" class="form-control">
                                <option value="0" {{ !$user->root_admin ? 'selected="selected"' : '' }}>User</option>
                                <option value="1" {{ $user->root_admin && !$user->super_admin ? 'selected="selected"' : '' }}>Admin</option>
                                @if(Auth::user()->super_admin)
                                <option value="2" {{ $user->super_admin ? 'selected="selected"' : '' }}>Super Admin</option>
                                @endif
                            </select>
