...
const NavButtons = styled.div`
    ...
    .register {
        ${tw`px-6 py-2 bg-neutral-900 text-white rounded-full hover:bg-neutral-800 transition-colors shadow-lg`};
    }
`;
...
const ActionButtons = styled.div`
    ...
    .btn-secondary {
        ${tw`px-8 py-4 rounded-xl text-neutral-900 bg-white font-semibold transition-all shadow-lg`};
        &:hover {
            background: #f8fafc;
            transform: translateY(-2px);
        }
...
const StatCard = styled.div`
    ...
    h3 {
        ${tw`text-xs font-bold text-neutral-400 tracking-wider uppercase mb-1`};
    }
    ...
    p {
        ${tw`text-xs text-neutral-500 leading-relaxed`};
    }
`;
